...
namespace POS.Views
{
    ...
    bool result = ViewModel.AddCustomer(newCustomer);
        ...
        private async Task DeleteCustomerAsync()
        {
            ...
            {
                Title = "Xác nhận xóa",
                Content = $"Bạn có chắc muốn xóa nguyên liệu '{ViewModel.SelectedCustomer.IngredientName}'?",
        ...
        private async void DeleteCustomer()
        {
            ...
            {
                Title = "Xác nhận xóa",
                Content = $"Bạn có chắc muốn xóa khách hàng '{ViewModel.SelectedCustomer.CustomerName}'?",
