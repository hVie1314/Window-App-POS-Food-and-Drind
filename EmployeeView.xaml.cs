...
namespace POS.Views
{
    ...
    public sealed partial class EmployeeView : Page
    {
        ...
        private async Task DeleteEmployeeAsync()
        {
            ...
            {
                Title = "Xác nhận xóa",
                Content = $"Bạn có chắc muốn xóa nhân viên '{ViewModel.SelectedEmployee.IngredientName}'?",
        ...
        private async void DeleteEmployee()
        {
            ...
            {
                Title = "Xác nhận xóa",
                Content = $"Bạn có chắc muốn xóa nguyên liệu '{ViewModel.SelectedEmployee.IngredientName}'?",
